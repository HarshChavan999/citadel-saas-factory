...
See the [Quick Start](quickstart.md) guide to get up and running in minutes.
...
- [GitHub Repository](https://github.com/Citadel-Management/citadel-saas-factory)
- [Citadel Management](https://citadelmanagement.com)
